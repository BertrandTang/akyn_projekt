...
document.getElementById('sendButton').addEventListener('click', async () => {
    ...
    try {
        ...
        messages.push({ role: "user", content: `Réponds moi comme si tu étais Yoda : "${userInput}"` }); // Ajout du message utilisateur
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (startBtn && starterZone && chatZone) {
        startBtn.addEventListener('click', async () => {
            ...
            const initialPrompt = "Fais-moi deviner un personnage de l'univers Star Wars en incarnant Yoda. Fais moi deviner un personnage de Star Wars mais ne me donne pas la réponse. Si j'ai la bonne réponse, propose moi de rejouer. Si je te demande la réponse, refuse-la moi 3 fois";
            ...
            try {
                ...
                loadingDiv.textContent = "Erreur lors de la récupération de la réponse.";
                console.error(error);
            }
        });
    }
